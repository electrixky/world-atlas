            ...
            {country && <div className="country-image grid grid-two-cols">
                ...
                <div className="country-content">
                    ...
                    <div className="infoContainer">
                        ...
                        <p><span className="card-description">Population: </span>
                            {country.population.toLocaleString()}
                        </p>
                        <p><span className="card-description">Region: </span>
                            {country.region}
                        </p>
                        <p><span className="card-description">Subregion: </span>
                            {country.subregion}
                        </p>
                        <p><span className="card-description">Top Level Domain: </span>
                            {country.tld[0]}
                        </p>
                        <p><span className="card-description">Currencies: </span>
                            {Object.keys(country.currencies).map((el) => country.currencies[el].name).join(", ")}
                        </p>
